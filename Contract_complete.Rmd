...
"SKIP","Design", "Scientific Studies and Confounding",
  #  "Spring Break",#  "",
  "Web Scraping",
  "Functions",
  "Data and Ethics",
  "Fitting and Interpreting Models",
  "Prediction, Overfitting, and Cross Validation",
...
- [ ] `r advdate(dayone, 10, topic)`
   - Finish Lab 9 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
  - Finish portfolio piece 5 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
- [ ] `r advdate(dayone, 11, topic)`
  - Finish Lab 10 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`     
  - Finish portfolio piece 6 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
- [ ] `r advdate(dayone, 12, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 14, assignment=startweek))`
     - Finish Lab 11 by `r startweek`:  `r advdate(dayone, 12, assignment=startweek)`
     - Finish portfolio piece 7 by `r startweek`:  `r advdate(dayone, 12, assignment=startweek)`
     
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0(" - Finish Lab 11 by ",startweek,": ",advdate(dayone, 15, assignment=startweek))`
  - Finish portfolio pieces 8 by `r startweek`:  `r advdate(dayone, 13, assignment=startweek)`
