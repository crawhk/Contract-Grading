...
"SKIP", "Scientific Studies and Confounding",
  #  "Spring Break",# 
  "Web Scraping and Data and Ethics","Functions", "THESIS","THESIS", "THESIS", "Overfitting and Models","Simulation", 
  "Quantifying Uncertainty and Large language model",
...
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 6 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
  - Finish portfolio piece 3 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 7 by `r startweek`:  `r advdate(dayone, 8, assignment=startweek)`
  - Finish Lab 9 by `r startweek`:  `r advdate(dayone, 8, assignment=startweek)`
- [ ] `r advdate(dayone, 9, topic)`
   - Finish Lab 8 by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
...
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0("- Finish Lab 10 by ",startweek,": ",advdate(dayone, 15, assignment=startweek))`
  - Finish Module 11 by `r startweek`:  `r advdate(dayone, 13, assignment=startweek)`
  - Finish portfolio pieces 5-6 by `r startweek`:  `r advdate(dayone, 13, assignment=startweek)`
- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio pieces 7-8 by `r startweek`:  `r advdate(dayone, 14, assignment=startweek)`
  - Finish Module 13 by `r startweek`:  `r advdate(dayone, 14, assignment=startweek)`
- [ ] `r advdate(dayone, 15, topic)`
  - Finish Lab 11 (Module 12) by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
  - Finish Modules 12 and 14 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
  - Finish portfolio piece 9 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
  
- [ ] Portfolio completion
  - Finish Module 15 `r startweek`: `r advdate(dayone, 16, assignment=startweek)`
  - Finish Portfolio 10 `r startweek`: `r advdate(dayone, 16, assignment=startweek)`
